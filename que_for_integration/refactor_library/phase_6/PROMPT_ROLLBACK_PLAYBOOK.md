...
- Record every published version in `library_integration_checklist.md` and `memory-bank/decisionLog.md` with date, scope, and evidence links.
...
3. Update `library_integration_checklist.md` and `memory-bank/decisionLog.md` documenting the rollback, rationale, and affected prompts.
