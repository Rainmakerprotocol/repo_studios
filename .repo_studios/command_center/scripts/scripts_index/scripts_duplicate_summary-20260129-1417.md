...
- Analysis dataset: `.repo_studios/command_center/scripts/scripts_index/scripts_analysis-20260129-1417.json`
...
1. `_parse_timestamp` — 17 duplicate(s)
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py:445-465 (21 line(s)): `def _parse_timestamp(raw: str | None) -> datetime:`

2. `configure_logging` — 15 duplicate(s)
    - orchestrators/run_test_execution_telemetry.py:516-522 (7 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py:516-522 (7 line(s)): `def configure_logging(level: str) -> None:`
...
3. `_relativize` — 13 duplicate(s)
    ...
    - orchestrators/run_test_execution_telemetry.py:588-603 (16 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py:588-603 (16 line(s)): `def _relativize(path: Path | None, repo_root: Path) -> str | None:`
...
7. `build_paths` — 8 duplicate(s)
    - orchestrators/run_test_execution_telemetry.py:468-486 (19 line(s)): `sample unavailable`
