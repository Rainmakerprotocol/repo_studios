...
def build_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument("--manifest-schema-version", default=DEFAULT_MANIFEST_SCHEMA_VERSION, help="Schema version to embed in manifest")
	parser.add_argument("--metrics-schema-version", default=DEFAULT_METRICS_SCHEMA_VERSION, help="Schema version to embed in metrics summary")
	...
	parser.add_argument("--guardrail-override", action="store_true", help="Indicate whether the guardrail override flag was used")
