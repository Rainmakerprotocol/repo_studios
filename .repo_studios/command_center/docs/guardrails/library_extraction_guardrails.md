...
1. **Rollback bundle contents**
   ...
   - `manifest.json` – summary of touched files, referencing duplicate group IDs (see `.repo_studios/command_center/docs/guardrails/automation_manifest_schema.md`).
   - `metrics_summary.json` – impact snapshot that follows `.repo_studios/command_center/docs/metrics/metrics_summary_schema.md`.
