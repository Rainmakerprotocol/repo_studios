...
| `metrics_summary` | object | Yes | Embedded metrics payload following `.repo_studios/command_center/docs/metrics/metrics_summary_schema.md`. |
...
```json
{
  ...
  "config_path": ".repo_studios/command_center/docs/guardrails/automation_config.yaml",
  "allow_list_source": ".repo_studios/command_center/docs/guardrails/allowed_targets.yaml",
  "metadata": {"version": "1"}
}
```
