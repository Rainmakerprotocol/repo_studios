...
- Analysis dataset: `.repo_studios/command_center/scripts/scripts_index/scripts_analysis-20251217-2039.json`
...
1. `_parse_timestamp` — 27 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:400-409 (10 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:237-246 (10 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_docs_health_overview.py:400-409 (10 line(s)): `def _parse_timestamp(raw: str | None) -> datetime:`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py:237-246 (10 line(s)): `def _parse_timestamp(raw: str | None) -> datetime:`
    ...
    - .repo_studios/command_center/scripts/producers/analyze_standards_index_gaps.py:168-177 (10 line(s)): `def _resolve_timestamp(raw: str | None) -> datetime:`
...
2. `configure_logging` — 22 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:442-446 (5 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:272-273 (2 line(s)): `sample unavailable`
...
3. `build_paths` — 15 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:412-413 (2 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:249-250 (2 line(s)): `sample unavailable`
...
4. `_relativize` — 13 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:468-474 (7 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:309-315 (7 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_docs_health_overview.py:468-474 (7 line(s)): `def _relativize(path: Path | None, repo_root: Path) -> str | None:`
    ...
    - .repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py:309-315 (7 line(s)): `def _relativize(path: Path | None, repo_root: Path) -> str | None:`
...
5. `run` — 12 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:920-1332 (413 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:485-683 (199 line(s)): `sample unavailable`
...
6. `_resolve_optional_path` — 10 duplicate(s)
    ...
    - producers/analyze_standards_index_gaps.py:159-165 (7 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/producers/analyze_standards_index_gaps.py:159-165 (7 line(s)): `def _resolve_optional_path(repo_root: Path, raw: str | None) -> Path | None:`
...
7. `build_options` — 10 duplicate(s)
    ...
    - orchestrators/run_docs_health_overview.py:416-439 (24 line(s)): `sample unavailable`
    - orchestrators/run_test_execution_telemetry.py:253-269 (17 line(s)): `sample unavailable`
...
8. `parse_args` — 9 duplicate(s)
    - orchestrators/orchestrate_full_diagnostic.py:172-194 (23 line(s)): `sample unavailable`
    - orchestrators/run_automation_dry_run.py:79-118 (40 line(s)): `sample unavailable`
    - orchestrators/run_dependency_import_hygiene.py:237-309 (73 line(s)): `sample unavailable`
    - orchestrators/run_docs_health_overview.py:335-397 (63 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:195-234 (40 line(s)): `sample unavailable`
    - producers/analyze_standards_index_gaps.py:121-151 (31 line(s)): `sample unavailable`

9. `_register_scripts` — 8 duplicate(s)
    ...
    - orchestrators/run_test_execution_telemetry.py:471-482 (12 line(s)): `sample unavailable`
...
10. `main` — 8 duplicate(s)
    ...
    - orchestrators/run_automation_dry_run.py:461-462 (2 line(s)): `sample unavailable`
    - orchestrators/run_dependency_import_hygiene.py:1121-1122 (2 line(s)): `sample unavailable`
    - orchestrators/run_docs_health_overview.py:1335-1336 (2 line(s)): `sample unavailable`
    ...
    - orchestrators/run_test_execution_telemetry.py:686-687 (2 line(s)): `sample unavailable`
