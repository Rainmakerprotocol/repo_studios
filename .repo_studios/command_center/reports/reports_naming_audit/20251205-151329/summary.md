...
- Generated at: 2025-12-05T15:13:29.796066+00:00
- Scanned files: 185
- Compliant files: 28
- Violations: 157
- Compliance ratio: 0.1514

## Issue Totals

| Issue | Count |
| --- | --- |
| insufficient_depth | 132 |
| invalid_timestamp | 6 |
| invalid_viewer_slug | 6 |
| latest_alias_present | 13 |
| unexpected_artifact_name | 25 |
...
| `commandview/standards_index_gaps/20251201-1744/bundle_summary.json` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251201-1744/candidates.tsv` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251201-1855/bundle_summary.json` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251201-1855/candidates.tsv` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251201-1857/bundle_summary.json` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251201-1857/candidates.tsv` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251203-0801/bundle_summary.json` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251203-0801/candidates.tsv` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251203-1212/bundle_summary.json` | unexpected_artifact_name |
| `commandview/standards_index_gaps/20251203-1212/candidates.tsv` | unexpected_artifact_name |
...
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_144920-20251126_144316/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_144920-20251126_144316/summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_144920-20251126_144316/SUMMARY.md` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_151413-20251126_144316/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_151413-20251126_144316/summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-26_151413-20251126_144316/SUMMARY.md` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-28_172641-2025-11-28_1702/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-28_172641-2025-11-28_1702/summary.json` | insufficient_depth |
| `fault_artifacts_consumer/fault_artifacts-2025-11-28_172641-2025-11-28_1702/SUMMARY.md` | insufficient_depth |
...
| `fault_artifacts_producer/faulthandler_report-20251129_154254/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251129_154254/report.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251129_154254/report.md` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032409/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032409/report.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032409/report.md` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032410/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032410/report.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_032410/report.md` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_130256/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_130256/report.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_130256/report.md` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_131330/bundle_summary.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_131330/report.json` | insufficient_depth |
| `fault_artifacts_producer/faulthandler_report-20251201_131330/report.md` | insufficient_depth |
...
| `fault_pipeline_orchestrator/fault_pipeline-20251126_144920/bundle_summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_144920/pipeline.log` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_144920/summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_144920/SUMMARY.md` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_151413/bundle_summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_151413/pipeline.log` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_151413/summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251126_151413/SUMMARY.md` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251128_172641/bundle_summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251128_172641/pipeline.log` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251128_172641/summary.json` | insufficient_depth |
| `fault_pipeline_orchestrator/fault_pipeline-20251128_172641/SUMMARY.md` | insufficient_depth |
...
| `healthview/standards_overview/20251203-1712/standards_overview.json` | unexpected_artifact_name |
| `healthview/standards_overview/20251203-1712/standards_overview.md` | unexpected_artifact_name |
