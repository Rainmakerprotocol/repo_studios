...
1. `_load_slugify` — 6 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:20-29 (10 line(s)): `sample unavailable`
    ...
    - .repo_studios/command_center/scripts/producers/generate_commandview_inventory.py:20-29 (10 line(s)): `def _load_slugify() -> Callable[[Path], str]:`
...
2. `build_paths` — 6 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:182-203 (22 line(s)): `sample unavailable`
    - summarizers/generate_function_analysis.py:93-114 (22 line(s)): `sample unavailable`
    - .repo_studios/command_center/scripts/producers/generate_commandview_inventory.py:182-203 (22 line(s)): `def build_paths(args: argparse.Namespace) -> Paths:`
...
5. `build_options` — 4 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:206-207 (2 line(s)): `sample unavailable`
...
6. `configure_logging` — 4 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:210-211 (2 line(s)): `sample unavailable`
...
7. `parse_args` — 4 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:143-176 (34 line(s)): `sample unavailable`
...
8. `run` — 4 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:856-901 (46 line(s)): `sample unavailable`
...
9. `main` — 3 duplicate(s)
    ...
    - producers/generate_commandview_inventory.py:904-905 (2 line(s)): `sample unavailable`
