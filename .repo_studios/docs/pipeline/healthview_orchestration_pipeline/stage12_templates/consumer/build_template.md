...
|-------|--------|---------|--------|
| `SCRIPT_PATH` | Assignment or discovery | `.repo_studios/scripts/consumers/process_health_report.py` | `PENDING` |
...
- [ ] Section 7.3 — Upstream dependency verified (bundle exists, manifest valid)
...
| Upstream dependency | ✅ | Section 7.3 verified |
...
| `<UPSTREAM_BUNDLE>` | Path to upstream producer bundle this consumer reads |
...
| `<path>:<line>` | Line reference format (e.g., `.repo_studios/scripts/consumers/script.py:123`) |
| `<path>:<start>-<end>` | Line range format (e.g., `.repo_studios/scripts/consumers/script.py:45-67`) |
