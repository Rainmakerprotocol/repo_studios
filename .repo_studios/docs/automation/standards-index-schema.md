...
updated: 2025-11-27
summary: >-
  Schema contract for the standards index YAML (`.repo_studios/scripts/repo_standards_index.yaml`), detailing the deterministic structure consumed by Repo Studios automation and agents.
tags:
  - standards
  - schema
  - automation
...
This specification defines the structure of the standards index YAML (written to `.repo_studios/scripts/repo_standards_index.yaml`), which aggregates normalized rule objects for Repo Studios automation and agent workflows.
