...
- Status: **issues-found**
- Timestamp: 2026-01-29T17:10:18.116188+00:00
- Test files analyzed: 147
- Test functions: 569
- Total issues: 299
- High severity issues: 194
- High-priority files: 112
- Clean files: 19
...
- Key findings:
  ...
  - [HIGH] Test 'test_execute_coverage_finds_run_dir' is 59 lines long. Consider decomposing. (line 113)
  - [HIGH] Test 'test_execute_hardening_passes_tests_dir' is 62 lines long. Consider decomposing. (line 174)
  - [MEDIUM] Test 'test_section_coverage_prefers_telemetry_metrics_even_when_zero' is 35 lines. Consider splitting for clarity. (line 263)
- Long tests:
  - `test_execute_coverage_finds_run_dir` — 59 lines (starts at 113)
  - `test_execute_hardening_passes_tests_dir` — 62 lines (starts at 174)
  - `test_run_generates_healthview_bundle` — 235 lines (starts at 317)
...
- Key findings:
  ...
  - [HIGH] Test 'test_refresh_coverage_xml_without_continue_on_error_exits_nonzero' is 59 lines long. Consider decomposing. (line 331)
  - [HIGH] Test 'test_refresh_omit_tests_creates_and_removes_cov_config' is 93 lines long. Consider decomposing. (line 392)
- Long tests:
...
- Issues by severity: high=3, medium=1, low=0
- Key findings:
  - [HIGH] Test 'test_anchor_health_uses_inventory_artifacts' is 97 lines long. Consider decomposing. (line 26)
  - [MEDIUM] Test 'test_anchor_health_falls_back_to_docs_scan' is 43 lines. Consider splitting for clarity. (line 125)
  - [HIGH] Test 'test_anchor_health_prunes_history' is 61 lines long. Consider decomposing. (line 170)
  - [HIGH] Test 'test_anchor_health_prunes_history' mutates module-level state. (line 170)
- Long tests:
  - `test_anchor_health_uses_inventory_artifacts` — 97 lines (starts at 26)
  - `test_anchor_health_prunes_history` — 61 lines (starts at 170)
...
- `.repo_studios/tests/tests_command_center/test_artifacts.py` (5 tests)
- `.repo_studios/tests/tests_command_center/test_prune_logs.py` (3 tests)
