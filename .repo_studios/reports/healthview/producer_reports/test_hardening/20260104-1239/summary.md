...
- Status: **issues-found**
- Timestamp: 2026-01-04T12:39:33.489848+00:00
...
- Priority score: 60
- Issues by severity: high=6, medium=0, low=0
- Key findings:
  ...
  - [HIGH] Test 'test_run_generates_healthview_bundle' is 235 lines long. Consider decomposing. (line 233)
- Long tests:
  - `test_execute_coverage_finds_run_dir` — 58 lines (starts at 113)
  - `test_execute_hardening_passes_tests_dir` — 58 lines (starts at 173)
  - `test_run_generates_healthview_bundle` — 235 lines (starts at 233)
