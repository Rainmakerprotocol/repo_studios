...
- Status: **issues-found**
- Timestamp: 2026-01-04T14:26:16.415098+00:00
...
- Key findings:
  ...
  - [HIGH] Test 'test_run_generates_healthview_bundle' is 235 lines long. Consider decomposing. (line 258)
- Long tests:
  - `test_execute_coverage_finds_run_dir` — 58 lines (starts at 113)
  - `test_execute_hardening_passes_tests_dir` — 58 lines (starts at 173)
  - `test_run_generates_healthview_bundle` — 235 lines (starts at 258)
