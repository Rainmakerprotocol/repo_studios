...
- Status: **issues-found**
- Timestamp: 2025-12-27T17:55:07.903717+00:00
- Test files analyzed: 144
- Test functions: 441
- Total issues: 272
- High severity issues: 178
- High-priority files: 107
- Clean files: 19
...
- Key findings:
  ...
  - [HIGH] Test 'test_run_generates_healthview_bundle' is 235 lines long. Consider decomposing. (line 113)
  - [HIGH] Test 'test_run_handles_missing_logs' is 111 lines long. Consider decomposing. (line 350)
- Long tests:
  - `test_run_generates_healthview_bundle` — 235 lines (starts at 113)
  - `test_run_handles_missing_logs` — 111 lines (starts at 350)
...
- Issues by severity: high=3, medium=1, low=0
- Key findings:
  - [HIGH] Test 'test_anchor_health_uses_inventory_artifacts' is 90 lines long. Consider decomposing. (line 26)
  - [MEDIUM] Test 'test_anchor_health_falls_back_to_docs_scan' is 43 lines. Consider splitting for clarity. (line 118)
  - [HIGH] Test 'test_anchor_health_prunes_history' is 61 lines long. Consider decomposing. (line 163)
  - [HIGH] Test 'test_anchor_health_prunes_history' mutates module-level state. (line 163)
- Long tests:
  - `test_anchor_health_uses_inventory_artifacts` — 90 lines (starts at 26)
  - `test_anchor_health_prunes_history` — 61 lines (starts at 163)
...
- Issues by severity: high=3, medium=1, low=0
- Key findings:
  - [HIGH] Test 'test_generate_test_log_health_report_prefers_producer_bundle' is 153 lines long. Consider decomposing. (line 59)
  - [HIGH] Test 'test_generate_test_log_health_report_falls_back_to_logs' is 68 lines long. Consider decomposing. (line 214)
  - [MEDIUM] Test 'test_generate_test_log_health_report_prunes_history' is 49 lines. Consider splitting for clarity. (line 284)
  - [HIGH] Test 'test_generate_test_log_health_report_prunes_history' mutates module-level state. (line 284)
- Long tests:
  - `test_generate_test_log_health_report_prefers_producer_bundle` — 153 lines (starts at 59)
  - `test_generate_test_log_health_report_falls_back_to_logs` — 68 lines (starts at 214)
