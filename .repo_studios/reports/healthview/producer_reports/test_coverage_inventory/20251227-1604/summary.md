...
- run_timestamp: 20251227-1604
- generated_utc: 2025-12-27T16:04:47.037969+00:00
- coverage_source: .repo_studios/tmp_cli_probe/coverage_repo.xml
- status: ok
- total_files: 82
- total_functions: 1544
- covered_functions: 1509
- overall_coverage_pct: 97.73
...
| `.repo_studios/command_center/scripts/aggregators/generate_metrics_summary.py` | 8 | 7 | 87.50 | _write_summary |
| `.repo_studios/scripts/consumers/generate_anchor_health_report.py` | 21 | 19 | 90.48 | Cluster.file_count, main |
| `.repo_studios/scripts/producers/generate_standards_index.py` | 32 | 29 | 90.62 | _dynamic_import_extract, _absent, _empty |
| `.repo_studios/scripts/producers/generate_test_coverage_inventory.py` | 24 | 22 | 91.67 | _run_pytest_suite, _render_final_xml |
| `.repo_studios/command_center/scripts/orchestrators/orchestrate_full_diagnostic.py` | 15 | 14 | 93.33 | get_module |
| `.repo_studios/scripts/producers/check_inventory_health.py` | 16 | 15 | 93.75 | _is_timestamp_dir |
| `.repo_studios/scripts/producers/generate_lizard_report.py` | 29 | 28 | 96.55 | severity |
...
| `.repo_studios/command_center/scripts/producers/generate_commandview_inventory.py` | 108 | 107 | 99.07 | CoverageIndex.__bool__ |
...
| `.repo_studios/command_center/scripts/orchestrators/run_test_execution_telemetry.py` | 21 | 21 | 100.00 | (none) |
| `.repo_studios/command_center/scripts/producers/analyze_standards_index_gaps.py` | 24 | 24 | 100.00 | (none) |
| `.repo_studios/command_center/scripts/producers/audit_helper_adoption.py` | 17 | 17 | 100.00 | (none) |
...
| `.repo_studios/scripts/consumers/generate_fault_artifacts.py` | 20 | 20 | 100.00 | (none) |
...
| `.repo_studios/scripts/producers/generate_import_graph_report.py` | 14 | 14 | 100.00 | (none) |
| `.repo_studios/scripts/producers/generate_undocumented_logic_report.py` | 25 | 25 | 100.00 | (none) |
| `.repo_studios/scripts/producers/render_inventory_views.py` | 21 | 21 | 100.00 | (none) |
| `.repo_studios/scripts/producers/scan_code_placeholders.py` | 23 | 23 | 100.00 | (none) |
| `.repo_studios/scripts/producers/scan_monkey_patches.py` | 54 | 54 | 100.00 | (none) |
| `.repo_studios/scripts/producers/seed_standards_prompts.py` | 19 | 19 | 100.00 | (none) |
| `.repo_studios/scripts/producers/validate_import_boundaries.py` | 21 | 21 | 100.00 | (none) |
...
| `.repo_studios/scripts/summarizers/summarize_health_suite.py` | 45 | 45 | 100.00 | (none) |
| `.repo_studios/scripts/summarizers/summarize_standards.py` | 14 | 14 | 100.00 | (none) |
| `.repo_studios/scripts/utilities/anchor_inventory_loader.py` | 4 | 4 | 100.00 | (none) |
| `.repo_studios/scripts/utilities/configure_faulthandler_runtime.py` | 16 | 16 | 100.00 | (none) |
...
| `.repo_studios/scripts/utilities/refresh_mypy_baselines.py` | 19 | 19 | 100.00 | (none) |
