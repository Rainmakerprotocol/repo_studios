...
- Overall score: 62.27
- Status tally: warning=2, critical=2, healthy=1
...
### Hygiene — Warning (75.00)

Notes:

- Placeholder scan surfaced 5 matches.

| Metric | Value |
| --- | --- |
| placeholder_total_matches | 5 |
| placeholder_status | ok |

<!-- markdownlint-disable MD013 -->
Top findings:

- {"placeholder_by_pattern": {"NOTE": 2, "XXX": 3}}
<!-- markdownlint-enable MD013 -->
