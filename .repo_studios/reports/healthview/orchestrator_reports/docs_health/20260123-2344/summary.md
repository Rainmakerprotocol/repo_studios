...
Run: `20260123-2344` | Completed: 2026-01-23T23:46:03.080788+00:00

## Pipeline Status

| Step | Status | Detail |
| --- | --- | --- |
| doc-index | ✅ success | docs=334, headings=2468 |
...
| aggregate | ✅ success | overall=62.27 |

---

## Overall Score

**Artifact:** `.repo_studios/reports/healthview/aggregator_reports/docs_health_signals/20260123-2346`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/doc_index/20260123-2344`
...
| Placeholder Docs | 77 |
| Duplicate Slugs | 6 |
| Link Density | 0.8562874251497006 |

**Concerns:** ⚠️ 40 missing descriptions; ⚠️ 77 placeholder docs; ⚠️ 6 duplicate slugs

---

## Anchor Inventory

**Artifact:** `.repo_studios/reports/healthview/producer_reports/anchor_inventory/20260123-2344`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/markdown_anchor_validation/20260123-2344`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/docs_integrity_validation/20260123-2346`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/metrics_anchor_stub_validation/20260123-2344`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/code_doc_churn/20260123-2346`
...
**Artifact:** `.repo_studios/reports/healthview/producer_reports/undocumented_logic/20260123-2346`
