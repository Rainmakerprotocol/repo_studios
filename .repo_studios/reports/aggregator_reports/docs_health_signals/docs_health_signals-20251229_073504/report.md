...
Generated (UTC): 2025-12-29T07:35:04+00:00
...
### Hygiene — Critical (25.00)

Notes:

- Placeholder scan surfaced 7 matches.
- Monkey patch scan reported 103 findings.

| Metric | Value |
| --- | --- |
| placeholder_total_matches | 7 |
| placeholder_status | ok |
| monkey_patch_total_findings | 103 |
| monkey_patch_status | ok |

<!-- markdownlint-disable MD013 -->
Top findings:

- {"placeholder_by_pattern": {"TODO": 4, "XXX": 3}}
- {"monkey_patch_by_category": {"attribute_reassignment_on_import": 3, "global_env_mutation": 1, "setattr_on_import_or_class": 45, "sys_modules_assignment": 54}}
<!-- markdownlint-enable MD013 -->
