...
Generated (UTC): 2025-12-01T14:30:42+00:00
...
| entities_scanned | 805 |
| entities_missing_docs | 737 |
| docstring_coverage_percent | 8.45 |
...
| documents_with_cross_file_duplicates | 70 |
...
- {"documents": 83, "root": ".repo_studios"}
- {"documents": 11, "root": "standards"}
- {"documents": 2, "root": "automation"}
...
- Monkey patch scan reported 104 findings.

| Metric | Value |
| --- | --- |
| placeholder_total_matches | 0 |
| placeholder_status | ok |
| monkey_patch_total_findings | 104 |
| monkey_patch_status | ok |

<!-- markdownlint-disable MD013 -->
Top findings:

- {"monkey_patch_by_category": {"attribute_reassignment_on_import": 3, "global_env_mutation": 1, "setattr_on_import_or_class": 46, "sys_modules_assignment": 54}}
<!-- markdownlint-enable MD013 -->
