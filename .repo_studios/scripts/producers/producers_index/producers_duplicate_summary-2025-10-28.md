...
- Functions analysed: 466
- Scanner groups detected: 38
- Producer groups referenced: 51
- Scanner groups matched to producers: 30
- Scanner-only groups: 8

## Inputs

- Analysis dataset: `.repo_studios/scripts/producers/producers_index/producers_analysis-2025-10-27.json`
...
5. `main` — 11 duplicate(s)
    - analyze_test_hardening.py:594-596 (3 line(s)): `sample unavailable`
    - generate_anchor_inventory.py:343-376 (34 line(s)): `sample unavailable`
    - generate_dependency_hygiene_report.py:332-411 (80 line(s)): `sample unavailable`
    - generate_import_graph_report.py:365-428 (64 line(s)): `sample unavailable`
    - validate_inventory.py:528-614 (87 line(s)): `sample unavailable`
    - verify_docs_integrity.py:590-592 (3 line(s)): `sample unavailable`
...
9. `_sanitize_slug` — 7 duplicate(s)
    - generate_lizard_report.py:152-155 (4 line(s)): `sample unavailable`
    - generate_standards_index.py:394-398 (5 line(s)): `sample unavailable`
    - generate_typecheck_report.py:65-69 (5 line(s)): `sample unavailable`
    - render_inventory_views.py:65-66 (2 line(s)): `sample unavailable`
    - validate_inventory.py:173-174 (2 line(s)): `sample unavailable`
