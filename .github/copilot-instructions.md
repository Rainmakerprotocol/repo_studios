...
- JavaScript contributions follow `.repo_studios/docs/standards/global/std-global-javascript-engineering.md`; ensure linting, module boundaries, and async handling align before opening a PR.
- CSS updates adhere to `.repo_studios/docs/standards/global/std-global-css-authoring.md`, including naming conventions, specificity thresholds, and accessibility safeguards.
...
- Frontend work references `docs/standards/global/std-global-javascript-engineering.md` and `docs/standards/global/std-global-css-authoring.md` alongside the existing markdown and HTML standards.
